...
const texts = {
    'pt-br': `<p>Olá! Meu nome é Carolina, sou Desenvolvedora Web Front-web há 1 ano. Faço o bootcamp da Labenu de Desenvolvimento Web Full-Stack (voltado para o React.js) e também o Santander Bootcamp 2023 - Fullstack Java + Angular, ambos com previsão para finalizar em outubro deste ano. Além disso, também participei do bootcamp Fundamentos de Desenvolvimento Web Front-end, do Instituto Nu by Descomplica, concluído em julho deste ano. Nos meus estudos aprendi diversas tecnologias: HTMl, CSS, JavaScript, React.js, Styled-components, React hooks, Next.js, APIs Rest e Bootstrap. Agora, conforme mencionado, estou aprendendo Java e Angular. </p>
